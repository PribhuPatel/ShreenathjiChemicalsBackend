...
exports.add = async (req, res) => {
    ...
    // let data =
       let payment = await paymentsModel.create({ customer:customerId, amount:quantity * price * (-1), type:"Ordered",status:"Approved",order:data._id,description:"New Order Added" });
    // let customerData =
